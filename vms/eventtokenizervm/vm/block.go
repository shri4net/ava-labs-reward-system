...
type Block struct {
	*core.Block `serialize:"true"`
	...
	//
	UniqueID          ids.ID      `serialize:"true"`
	TrackID           ids.ID      `serialize:"true"`
	EventContractAddr ids.ShortID `serialize:"true"`
	EncEventData      []byte      `serialize:"true"`
	EventTime         int64       `serialize:"true"`
}
