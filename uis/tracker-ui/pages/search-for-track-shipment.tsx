import { Heading, Input, Button, Flex, Stack, useColorModeValue, FormControl, FormLabel, Icon, AlertDialog, AlertDialogOverlay, AlertDialogContent, AlertDialogHeader, AlertDialogCloseButton, AlertDialogBody, AlertDialogFooter, useDisclosure } from "@chakra-ui/react"
import React, { useRef, useState } from 'react'
import { FiTruck } from 'react-icons/fi';
import SimpleAlertDialog from "../components/simplealertdialog";
import {isTrackExists} from '../libraries/api-adapter'

interface SearchForTrackShipmentPageProps {
  onSearchClick: (id: string) => void;
}

const SearchForTrackShipmentPage = ({ onSearchClick, ...rest }: SearchForTrackShipmentPageProps) => {
      ...
      <Stack
        ...
        <Stack spacing={6} direction="row">
          ...
          <Button
            ...
            <Icon mr="4" fontSize="lg" as={FiTruck}/>
            Search
          </Button>
        </Stack>
      </Stack>
...
export default SearchForTrackShipmentPage
